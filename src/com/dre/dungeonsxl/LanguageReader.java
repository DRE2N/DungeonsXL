...
public class LanguageReader {
	...
	private void setDefaults() {
		...
		defaults.put("Log_Error_NoConsoleCommand", "&6/dxl &v1&4 kann man nicht als Konsole ausf�hren!");

		/* Player */
		defaults.put("Player_CheckpointReached", "&6Checkpoint erreicht!");
		defaults.put("Player_LootAdded", "&6Deinem Belohnungsinventar sind&4&v1&6 hinzugef�gt worden!");
		...
		defaults.put("Player_PortalIntroduction", "&6W�hle mit dem Holzschwert die zwei Eckpunkte des Portals!");
		defaults.put("Player_PortalDeleted", "&6Portal gel�scht!");
		defaults.put("Player_PortalProgress", "&6Erster Block gew�hlt, nun der zweite!");
		...
		defaults.put("Cmd_Chat_NormalChat", "&6Du bist nun im �ffentlichen Chat");
		defaults.put("Cmd_Chatspy_Stopped", "&6Du hast aufgeh�rt den DXL-Chat auszusp�hen!");
		defaults.put("Cmd_Chatspy_Start", "&Du hast begonnen den DXL-Chat auszusp�hen!");
		...
		defaults.put("Cmd_Msg_Added", "&6Neue Nachricht (&4&v1&6) hinzugef�gt!");
		...
		defaults.put("Error_Ready", "&4W�hle zuerst eine Klasse aus!");
		defaults.put("Error_Cooldown", "&4Du kannst den Dungeon nur alle &6&v1&4 Stunden betreten!");
		defaults.put("Error_Requirements", "&4Du erf�llst nicht die Anforderungen f�r diesen Dungeon!");
		defaults.put("Error_Leftklick", "&4Du musst das Schild mit Links-klick ber�hren!");
		...
		defaults.put("Error_NoPlayerCommand", "&6/dxl &v1&4 kann man nicht als Spieler ausf�hren!");
		defaults.put("Error_SignWrongFormat", "&4 Das Schild ist nicht im richtigen Format!");

		/* Help */
		defaults.put("Help_Cmd_Chat", "/dxl chat - �ndert den Chat-Modus");
		...
		defaults.put("Help_Cmd_Leave", "/dxl leave - Verl�sst den aktuellen Dungeon");
		defaults.put("Help_Cmd_Escape", "/dxl escape - Verl�sst den Dungeon, ohne ihn zu speichern");
